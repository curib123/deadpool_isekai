...
When he stops performing, joking, or addressing the reader as frequently, the change should matter.
...
These characters exist in Veyr before destination selection. None is guaranteed to join a permanent party, appear in Volume 1, or occupy a specific arc. Their future deployment belongs to later planning.
...
## Public Identity
A field auditor trained to investigate System irregularities, forged registrations, corrupted appraisal tools, and magical fraud.

## History
Maelis grew up in a family of municipal record-keepers who treated accuracy as a civic virtue. She entered the Ledger because she believed standardized truth could protect ordinary people from nobles, guilds, frauds, and superstition.

Her early career exposed a major registration scandal involving officials who altered certification records to deny workers pay. She became respected for refusing pressure from both nobles and her own supervisors.

## Goal
Prove that anomalies can be studied without dehumanizing the people involved.

## Fear
Discovering that the institutions she trusts value control more than truth.
...
- patient observation;
- precise memory;
- disciplined crossbow use;
- calm under bureaucratic pressure.

## Flaws
- controlling;
- skeptical past the point of tact;
- confuses evidence with emotional understanding;
...
## History
Tavian grew up in a pass community where a single careless person could kill an entire caravan. He joined the Wardens young, became a rescue specialist, and survived an avalanche that killed his first commander.

He distrusts unnecessary risk because he has buried people who thought confidence could substitute for preparation.

## Goal
Keep dangerous roads open and prove competence can save more lives than glory.

## Fear
Failing people because he underestimated a preventable danger.

## Strengths
- sword and polearm combat;
- mountain survival;
- tactical command;
- monster tracking;
- rescue operations;
...
## Flaws
- inflexible under uncertainty;
- harsh toward reckless people;
...
## History
Ilyra was raised between oasis cities in a merchant family whose wealth collapsed after a water-right dispute. She learned early that law, truth, and fairness are separate things unless someone knows how to negotiate all three.

She rebuilt her livelihood as a route broker, contract reader, translator, and caravan fixer.

## Goal
Build a trade network she owns outright and never again have her future controlled by another family's debt.
...
- appraisal of goods;
- social reading;
- concealed-knife defense.

## Flaws
- transactional;
- keeps emotional escape routes;
- assumes everyone has a price;
...
## Appearance
Short swept-back horns, bronze-brown skin, amber-black eyes, athletic build. Prefers practical dueling coats over ceremonial armor.

## History
Veska was born into a minor principality where demonic bloodlines were simultaneously feared, romanticized, and exploited as military prestige.

She rejected a state officer's commission rather than become a ceremonial weapon for someone else's politics.

## Goal
Become powerful and famous on terms no ruler, church, or bloodline can claim ownership over.

## Fear
Being reduced to a symbol rather than treated as a person.
...
- mana control;
- intimidation;
- patience during combat;
- excellent judgment of opponent habits.

## Flaws
- pride;
- vindictive memory;
- hates admitting admiration;
...
They can compete, cooperate, or oppose one another without either becoming the other's subordinate.
...
## History
Nemi trained in healing and memory-binding after losing a sibling during a regional magical blight. Their tradition taught that memory should help the living continue, not trap them inside grief.

Nemi has treated soldiers, criminals, children, travelers, and people who deserved consequences but still needed medicine.

## Goal
Preserve life without turning preservation into control.

## Fear
Using healing or memory magic to force someone to remain the person Nemi wants them to be.
...
## Flaws
- intrusive when worried;
- can become morally judgmental about reckless self-harm;
...
## History
Edrin grew up in a winter commune where survival work was shared and melodrama wasted heat. He became a scout because he trusted terrain more than politics.

A mapping expedition disappeared during an auroral storm. Edrin survived but returned with route measurements that contradicted his own field notes.

## Goal
Understand the Outer Pale's shifting geography without allowing institutions to bury dangerous evidence.

## Fear
That his own memory cannot be trusted.
...
- suspicious of magic explanations;
- stubborn;
...
## History
Aren came from a modest river district and advanced through transparent guild examinations rather than noble sponsorship. His reputation comes from taking dangerous contracts that protect communities rather than maximize profit.

He believes systems can be repaired and should be accountable rather than simply ignored.

## Goal
Become powerful enough to protect people without becoming another unaccountable strongman.

## Fear
That power inevitably isolates its wielder from ordinary consequences.

## Strengths
- disciplined sword-and-shield combat;
- protective magic;
- command presence;
- public trust;
- teamwork;
...
## Flaws
- overly responsible;
- distrustful of uncontrolled individuals;
- assumes accountability must be institutional;
...
## History
Morn spent three decades investigating cursed identities, forged classes, possession, registry collapse, and magical disasters caused by uncontained anomalies.

He has personally seen an apparently harmless registration fault spread through a town's ward network and kill civilians.

## Worldview
Civilization survives because dangerous exceptions are measured before they become disasters.

## Goal
Create a lawful containment protocol for entities the System cannot classify.

## Fear
Another catastrophe that everyone saw coming but refused to contain because the anomaly looked human.
...
- legal knowledge;
- anti-anomaly equipment;
- patience.

## Flaws
- paternalistic;
- willing to confine first and apologize later;
...
## History
Pell began as an archivist studying songs from communities erased by Ashfall events. Over time he became convinced that accepted reality is only the version that survived correction.

He now believes anomalies are opportunities to expose what the world has forgotten.

## Worldview
A stable lie is still a lie.

If reality must be injured to reveal the truth beneath it, the injury may be justified.

## Goal
Force undeniable evidence of forgotten or corrected history into public view.

## Fear
Dying inside a world whose deepest truths remain hidden forever.
...
- patient recruitment;
- relic access;
- willingness to endure personal cost.
...
This matrix defines foundation dynamics, not guaranteed future events.
...
| Veska ↔ Aren | proud independent vs civic hero | personal sovereignty vs social obligation |
| Nemi ↔ Pell | memory keeper vs truth absolutist | healing memory vs weaponizing memory |
| Edrin ↔ Maelis | field evidence vs registry evidence | map reality vs recorded reality |

# 6. Reusable Supporting-Cast Rules

A supporting character should not appear merely because the story “needs a healer,” “needs exposition,” or “needs someone to react.”
...
If those answers are weak, the character deployment fails QA.
...
## RIVAL-TYPE-02 — Moral/Institutional Rival
Challenges the assumption that freedom without accountability is always preferable.
...
## RIVAL-TYPE-04 — Performance Rival
Competes in reputation, intimidation, spectacle, or symbolic authority without necessarily sharing his ethics.
...
## 8.1 Antagonist Categories

### ANTAG-TYPE-A — Local Power
Ruler, guild leader, crime boss, religious authority, military commander, or political operator whose goals arise from a specific place.
...
Foundation example: Provost Morn.

### ANTAG-TYPE-C — Ideological Absolutist
Values truth, order, freedom, purity, destiny, faith, or survival so completely that people become expendable.
...
### ANTAG-TYPE-F — Fate-Aligned Stabilizer
Person or entity whose interests align with restoring a heavily reinforced outcome.

Identity and deeper mechanics must wait for Mystery Foundation.

### ANTAG-TYPE-G — Great-Design-Level Opposition
Reserved.

Do not create the final villain, true agent, avatar, or master of the Great Design during Phase 2.

That belongs to Mystery Foundation and later series architecture.

# 9. Antagonist Quality Rules
...
- antagonists who know mysteries without a source;
- antagonists who exist only to be humiliated.

# 10. Character Deployment Boundaries

Phase 2 does not decide:
- who appears in the first destination;
- permanent party membership;
- romances;
- deaths;
- betrayals;
- final rival outcomes;
- final villain identity;
- destination-specific antagonists;
- volume-by-volume character arcs.

Those decisions require later Destination, Mystery, Volume, and Chapter planning.
