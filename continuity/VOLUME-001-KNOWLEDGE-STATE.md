...
- Ledger procedures;
- historical partial registration failures;
- Greywake record discrepancies that justify her audit;
- common fraud patterns.

## May Learn During Volume
- Red Jackal's identity failure exceeds normal anti-appraisal or damaged-record cases;
- physical data can be measured while identity data remains undefined;
- Greywake road records were deliberately manipulated;
- Guild records excluded or obscured politically weak casualties.
...
## Begins Volume Knowing
- monster migration behavior;
- frontier rescue practice;
- route-safety logic;
- recent abnormal route drift.

## May Learn During Volume
- Greywake's migration is being manipulated by march-lures;
- Red Jackal regenerates unusually;
- Red Jackal can become reliable under pressure despite reckless habits.

## Must Not Learn Yet
- deeper anomaly origin;
- Great Design;
- Savael;
- Exterior Needle;
...
## Begins Volume Knowing
- complete Greywake march-lure scheme;
- falsified road-loss policy;
- economic/political motive;
- Guild route intelligence.

## May Learn During Volume
- Red Jackal has no valid System identity;
- Red Jackal is unusually durable and useful;
- Red Jackal may be exploitable as off-book labor or scapegoat.
...
Begins with local militia knowledge and suspicions that Guild priorities are distorting defense allocation.

May learn the lure scheme after evidence emerges.

Does not begin knowing the conspiracy.

# Sela Arven

Begins with practical medical knowledge.

May observe that Red Jackal's recovery does not behave like normal healing or a familiar racial trait.

Does not infer the writer-truth self-model mechanism.

# Kellan Dorr

Begins knowing outer homesteads are receiving disproportionately poor warnings and protection.

He suspects political abandonment but does not begin with proof of march-lure manipulation.

# Jessa Vale

Begins knowing pieces of route paperwork are irregular and that some reports are altered or omitted.

She knows enough to feel complicit but does not initially understand the entire migration geometry or every decision Hesk made.

# Public Greywake Knowledge

At volume opening, ordinary residents generally believe:
- monster seasons are worsening;
- outer roads are dangerous;
- the main caravan route has been kept open through Guild competence;
- frontier losses are unfortunate but normal;
- Red Jackal is suspicious because the System cannot classify him.

By local resolution, public knowledge may include:
- the migration was deliberately manipulated;
- the Guild concealed unequal risk;
- Red Jackal is genuinely unregistered/undefined, but why remains unknown.
...
Volume 1 must not create retroactive knowledge for any character merely to speed up exposition.
