...
15. avoid Greywake-rumor/reputation introduction, which belongs primarily to CH-029;
16. introduce no Cassian/Venn clue, sabotage clue, charter politics, or conspiracy evidence;
...
CH-001 through CH-026 are CANON.
...
- ordinary pack, food/water, bandages, and coin/resources only;
- no legendary reward;
- no class;
- no level;
...
Do not specify an unsupported exact Greywake-to-Merrowgate distance.
...
Travel benchmarks remain consistent with World Bible limits.

Do not:
- imply instant cross-country movement;
- use a licensed gate;
- create a new named intermediary city that would require World Bible canon;
- compress the route into a single unexplained transition.

# 4. Route Lock

The approved chapter route is intentionally generic but canon-compatible:

**Greywake / Hollow March departure**
→ **southbound Avarran road and river transfer network**
→ **larger commercial transfer point(s)**
...
- river landings;
- ferries/barges;
- coastal-facing commercial roads;
- final port approach.

The manuscript should use only as many transitions as needed to make travel feel real.
...
- food;
- simple lodging/rest space where needed;
- road/river fare;
- baggage/passenger transfer;
- minor ordinary fees.

Do not lock an exact coin total unless existing canon supports it.
...
- transport crew;
- river landing;
- customs/transfer desk;
- or other trade-heavy institution

has an established **Wayfarer Tongue Token** nearby.
...
- stiffness after long sitting/standing;
- residual leg or shoulder soreness;
- fatigue after long travel days;
- bandages carried because Sela gave them to him.

Do not:
- reopen the Greywake wound as a major injury;
- make him completely fresh;
- use regeneration as a spectacle;
- introduce a new major injury.
...
- sensory travel detail should dominate early;
- humor comes from money, discomfort, unreadable bureaucracy, and failed coolness;
...
CH-027 may naturally establish:

- larger traffic volume than Greywake;
- more varied clothing/accent/cargo;
- Avarran and Brasswater trade movement;
- bigger river/coastal vessels;
- cranes, masts, warehouses, chain bridges, stacked dock structures at a distance;
- trade-heavy Wayfarer Token use;
- ordinary transfer fees and passenger/cargo organization.

CH-027 must not yet explain:

- Harbor Council structure;
- Venn Maritime House;
- Unified Harbor Security Charter;
- Harbor Watch politics;
- named shipwright houses;
- smuggling networks;
- detailed Merrowgate law;
- sabotage pattern;
- merchant-faction conflict.

Those belong to later chapters.

# 10. Action / Hazard Lock

One bounded travel hazard is required.

Approved hazard:

**During a busy river/cargo transfer, a loaded handcart or compact cargo pallet shifts on a wet boarding ramp after a wake/current movement or poorly timed transfer.**
...
- no sabotage;
- no monster attack;
- no mysterious failure.

The hazard is ordinary transport friction.
...
Porters, crews, and merchants are too busy moving cargo to reward the performance.
...
CH-027 does not advance:
- M-002;
- M-011;
- M-007;
- any protected mystery.

Do not include:
- failed System identification;
- strange gate response;
- soul-registry behavior;
- ancient terminology;
- prophecy;
- divine claim;
- Fate disturbance;
- Exterior imagery;
- unexplained anomaly reaction.

CH-028 owns the Merrowgate identity-verification reinforcement.

# 13. Named-Cast Lock

Named Volume 2 cast are held for later authorized introductions.

CH-027 must not introduce by name:
...
Ordinary travelers, merchants, boat crew, porters, and clerks remain unnamed or functional background figures unless a minor incidental name becomes absolutely necessary during prose drafting.
...
Open Volume 2 with movement and consequence rather than a reset.
...
- his body is better than at Greywake departure but travel still finds the sore places;
...
He does not regret leaving Greywake, but he is forced to admit that wandering without a destination is easier when somebody else is paying for the road.

### Voice / Internal Function

Use dry practical observation rather than emotional monologue.

Possible internal emphasis:
- freedom has invoices;
- roads do not care about dramatic departures;
- every stop has discovered a new reason to charge money.

These are tonal directions, not final prose.
...
- confirm price or departure timing;
- make clear the route continues toward the Brasswater trade sphere.

### Worldbuilding Limit

Show transport scale increasing.

Do not explain Merrowgate politics.
...
Turn travel cost and language limitations into active scene pressure.
...
He cannot ignore the person controlling the boat ramp when that person wants the fare.

### Dialogue Function

Short transaction dialogue.
...
Provide the roadmap's bounded travel hazard and demonstrate post-Greywake behavioral growth without power escalation.

### Trigger

A wake/current shift or poor timing moves the vessel/ramp while a loaded handcart or compact cargo pallet is being transferred.

The load begins to slide.

This is an ordinary hazard.
...
- load is stabilized without Play Logic;
- no sabotage;
...
Do not turn the beat into self-congratulatory growth narration.

### Dialogue Function

Crew speech is functional:
- hold;
- move;
- release;
- wait;
...
Deliver the chapter title and make the environmental transition from inland/frontier life to maritime commerce feel physical.

### Required Beats

- air becomes wetter/saltier;
...
He is interested, not overwhelmed into sentimentality.
...
- somebody may gesture for him to get out of the cargo path;
- nobody gives the entrance the weight he intended.

### Comedy Function

The port economy is too busy to appreciate mystery.
...
Land the chapter on the first full reveal of the Volume 2 destination and hand cleanly into CH-028.
...
- masts;
- warehouse stacks;
- guild/merchant flags without identifying every faction;
- dense foot and cargo traffic;
- foreign-quarter visual variety at a distance;
- boats/vessels arriving and departing.

### Required Practical Beats
...
**large port = money + information + movement.**

Not because:
- prophecy called him;
- a quest appeared;
- Cassian targeted him;
- someone from Greywake sent him;
- a mystery clue pulled him there.

### Dialogue Function

Minimal final interaction, if any.

A porter/crew member may point him toward arrivals or tell him not to block traffic using nearby translation support.

No named cast introduction.

### Mystery / Antagonist Lock

No Cassian.
No Venn symbol singled out as ominous.
No sabotage clue.
No identity failure.
No F-ID.
No M-ID advancement.
...
Every scene creates a practical reason for the next one.

# 17. Dialogue Architecture

CH-027 dialogue remains sparse and functional.
...
- SC-027-01: reflective movement / practical travel;
- SC-027-02: transactional friction;
- SC-027-03: short kinetic hazard;
- SC-027-04: sensory expansion / comedy;
- SC-027-05: destination reveal / forward pull.

The chapter should feel like a new arc beginning without behaving like a second series premiere.

Do not overextend the hazard.

Do not rush the final Merrowgate reveal.

# 19. Gate 8 Checklist

- five scenes only;
- SC-027-01 through SC-027-05 unique and complete;
- CH-026 departure carried forward;
- multiple-day travel implied;
...
- no Greywake companion;
- residual injury/recovery remains visible;
- one ordinary travel hazard only;
- no combat;
- no monster attack;
- no sabotage;
- no Play Logic;
